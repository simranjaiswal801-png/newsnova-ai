...
export default function App() {
  ...
  const handleExplain = (title) => {
    setAiResponse(
      `🤖 AI Explanation for ${user ? user.name : "you"}: ${title} explained in simple words.`,
    );
  };
              ...
              {user ? (
                <>
                  ...
                  <Button
                    ...
                    size="sm"
                    variant="outline"
                    className="border-gray-600 hover:bg-red-600/50"
                  >
                    Logout
                  </Button>
                </>
              ...
              <div className="lg:col-span-2">
                <div className="space-y-4">
                  <div className="flex gap-2 flex-wrap">
                    <span className="px-3 py-1 bg-white/10 rounded-full text-xs backdrop-blur-sm border border-white/20">
                      AI Generated
                    </span>
                    <span className="px-3 py-1 bg-white/10 rounded-full text-xs backdrop-blur-sm border border-white/20">
                      Simplified
      ...
      <footer className="bg-gray-900/50 backdrop-blur-md border-t border-gray-700/50 mt-12">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-1">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Your AI-powered news companion. Get instant explanations and
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-4">
                <a
                  ...
                  className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-purple-600 transition-all hover:scale-110"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <a
                  href="https://theprint.in/"
                  className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-all hover:scale-110"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                    <path d="M22.46 6c-.77 .35-1.6.58-2.46.69.88-.53 1.56-1.37 1.88-2.38-.83 .5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29 0 .34.04 .67.11 .98C8.28 9.09 5.11 7.38 3 4.79c-.37 .63-.58 1.37-.58 2.15 0 1.49.75 2.81 1.91 3.56-.71 0-1.37-.2-1.95-.5v.03c0 2.08 1.48 3.82 3.44 4.21a4.22 4.22 0 0 1-1.93 .07 4.28 4.28 0 0 0 4 2.98 8.52 8.52 0 0 1-5.33 1.84c-.34 0-.68-.02-1.02-.06C3.44 20.29 5.7 21 8.12 21 16 21 20.33 14.46 20.33 8.79 0 .52-.01-1-.01-2.47 0-.37 0-.74.02-1.11z" />
                  </svg>
                </a>
              </div>
          ...
          <div className="border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
            <p>
              &copy; 2026 NewsNova AI. Built with ❤️ by Simran. All rights
              reserved.
            </p>
          </div>
        </div>
